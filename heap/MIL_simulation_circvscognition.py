...
clock_freqs = [0.75, 0.8, 0.85, 0.9, 0.95, 1, 1.05, 1.1, 1.15, 1.2, 1.25] # [Hz]
no_fishes = 10
alpha = 0
test_runs = 100
...
# Standard Tank
arena_list = [elem * 3 for elem in [1780, 1780, 1170]] # 2000
...
for freq_iter, clock_freq in enumerate(clock_freqs):
    ...
    for test_run in range(test_runs):
        ...
        for fish_id in range(no_fishes):
            ...
            fishes.append(Fish(fish_id, dynamics, environment, alpha, clock_rate))
